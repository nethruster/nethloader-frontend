...
export default connect(mapStateToProps)(({icon, isTouchDevice, title, currentText, currentData, dataCopy, onClickExecute}) => {
  return (
    <div class={`flex flex-full-center flex-dc ${style.section}`} data-copytext={dataCopy} onClick={onClickExecute}>
      <Ink />
